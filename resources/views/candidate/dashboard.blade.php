    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="flex flex-col md:flex-row items-center md:items-start mb-8 gap-6">
            ...
            <div class="flex-shrink-0">
                <img src="{{ $user->profile_photo_path ? asset('storage/' . $user->profile_photo_path) : asset('images/default-avatar.png') }}"
                    alt="{{ $user->name }}"
                    class="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-blue-200 shadow-lg object-cover">
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 p-6 mb-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-50 rounded-xl border border-gray-100 p-5 hover:-translate-y-1 hover:shadow-xl transition duration-300">
                    {{-- Job Title --}}
                    <h3 class="text-lg font-semibold text-gray-800 mb-1">{{ $application->job->title ?? 'No Job Title' }}</h3>
                    {{-- Status Badge --}}
                    @php
                    $statusColors = [
                    ...
                    <p class="text-gray-500 text-sm mt-2 mb-2 flex items-center rounded-lg">
