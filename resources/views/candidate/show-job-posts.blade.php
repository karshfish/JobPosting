                        ...
                        <div class="flex flex-col items-center pb-6 border-b border-gray-200 md:border-b-0 md:border-r">
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <div class="mt-4 flex items-center justify-center text-sm">
                                    ...
                                    <span class="font-medium text-gray-900">{{ $post->salary_min}}</span>
                                </div>
                                @endif
                                ...
                                <div class="flex justify-end mt-3">
                                    <x-primary-button class="px-5 py-2"><a href="{{ route('candidate.jobs.apply', $job) }}" class="px-5 py-2">Apply</a></x-primary-button>
                                </div>

                                @else
                                <button disabled class="px-3 py-1.5 text-sm rounded mt-3 bg-gray-300 text-gray-600 cursor-not-allowed">
                                    Not Available
                                </button>
                                @endif
                            </div>
