<x-candidate-layout>
                            ...
                            <li>
                                <div class="flex items-center">
                                    <a href="{{ route('jobs.index') }}"
                                        class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">{{ __('Job Posts') }}</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Job Details') }}</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
    ...
    <main class="py-8 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto sm:p-6 lg:px-8 bg-white dark:bg-gray-900">
            @php
            $post = $post ?? ($job ?? null);
            @endphp
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <div class="text-center">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('No Job Found') }}</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('The job post you\'re looking for doesn\'t exist or has been removed.') }}
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('jobs.index') }}"
                            class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 dark:bg-indigo-700 hover:bg-indigo-700 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            <div class="md:grid grid-cols-12 gap-4">
                <div class="col-span-8 bg-white dark:bg-gray-800 p-4 rounded-lg shadow">

                    <!-- Job Description -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl mb-5 shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden p-6 relative">
                        <div class="prose max-w-none dark:prose-invert">
                            <div class="flex items-center space-x-2">
                                ...
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('About this position') }}
                                </h3>
                            </div>
                        ...
                        <div class="mt-1">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Benefits & Perks') }}</h3>
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    ...
                                    <span class="ml-3 text-sm text-gray-600 dark:text-gray-400">{{ $benefit }}</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl mb-5 shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden p-6 relative">
                        ...
                        <div class="mt-1">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Key Responsibilities') }}
                            </h3>
                            <ul class="mt-4 space-y-3">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="ml-3 text-gray-600 dark:text-gray-400">{{ $responsibility }}</span>
                                </li>
                                @endif
                                @endforeach
                            </ul>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl mb-5 shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden p-6 relative">
                        ...
                        <div class="mt-1">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Qualifications') }}</h3>
                            <div class="mt-4 flex flex-wrap gap-2">
                                @foreach ((array) $post->qualifications as $qualification)
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-md text-sm font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
                        ...
                        <div class="mt-1">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Required Skills') }}</h3>
                            <div class="mt-4 flex flex-wrap gap-2">
                                @foreach ($post->skills as $skill)
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-md text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mt-1">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Technologies') }}</h3>
                            <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <div class="md:col-span-2 space-y-8">
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('Posted On') }}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ __('Last Updated') }}
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <!-- Comments Section -->
                        <div class="mt-10">
                            <h3 class="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100 flex items-center">
                            ...
                            <form action="{{ route('comments.store', $job) }}" method="POST"
                                class="mb-6 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                                @csrf
                                <textarea name="content" rows="3"
                                    class="w-full rounded-md border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                You must <a href="{{ route('login') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">log
                                    in</a> to comment.
                            </p>
                            @endauth
                            ...
                            <div class="space-y-6 max-h-80 overflow-auto">
                                ...
                                <div x-data="{ openReply: false }" class="border dark:border-gray-700 p-3 rounded-md bg-white dark:bg-gray-800">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex justify-between items-start">
                                                <div>
                                                    <span
                                                        class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ $comment->user->name }}</span>
                                                ...
                                                <form action="{{ route('comments.destroy', $comment) }}"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="text-red-600 dark:text-red-400 text-xs hover:underline">Delete</button>
                                                </form>
                                                @endif
                                                @endauth
                                            </div>

                                            <div class="mt-1 text-gray-900 dark:text-gray-100">{{ $comment->content }}</div>

                                            {{-- Reply button --}}
                                            @auth
                                            <button type="button" @click="openReply = !openReply"
                                                class="text-blue-600 dark:text-blue-400 text-sm mt-2">Reply</button>

                                            <form x-show="openReply" action="{{ route('comments.store', $job) }}"
                                                method="POST" class="mt-2">
                                                @csrf
                                                <input type="hidden" name="parent_id" value="{{ $comment->id }}">
                                                <textarea name="content" rows="2" class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                                            ...
                                            <div class="mt-3 ml-6 space-y-3 border-l dark:border-gray-600 pl-4">
                                                ...
                                                <div class="flex items-start space-x-3 text-sm">
                                                    <div class="flex-shrink-0">
                                                        ...
                                                        @else
                                                        <div
                                                            class="h-8 w-8 rounded-full bg-indigo-500 flex items-center justify-center text-white font-medium text-xs">
                                                    ...
                                                    <div class="flex-1">
                                                        <div class="flex justify-between items-start">
                                                            <span
                                                                class="font-medium text-gray-700 dark:text-gray-300">{{ $reply->user->name }}</span>
                                                            @auth
                ...
                <div class="bg-white dark:bg-gray-800 h-96 relative md:col-span-4 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-200">
                    <!-- Status Badge -->
                    ...
                    {{ $s === 'published' ? 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300' :
                       ($s === 'draft' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300' :
                       ($s === 'closed' ? 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300' :
                    ...
                    <!-- Company Logo -->
                    <div class="w-24 h-24 mx-auto mb-5 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-700 border dark:border-gray-600 flex items-center justify-center">
