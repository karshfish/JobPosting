                ...
                <section class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-8">
                        <div class="text-center">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('jobs.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
